...
import { MatchMakingEntryRowPacket, getAllUsersInMatchmakingQueue } from "../utility/getAllUsersInMatchmakingQueue";
import { MatchMakingEntry, MatchMakingLobby, matchmaking } from "../utility/matchmaking";
...
const mockMatchmakingData: MatchMakingLobby[] = [{game_id: 1, lobby: mockGetAllUsers}] 
describe("matchmakingJob", () => {
  afterEach(() => {
    jest.clearAllMocks();
  });

  it("should not call any functions if there are less than 5 users in the matchmaking queue", async () => {
    const mockedGetAllUsersInMatchmakingQueue = getAllUsersInMatchmakingQueue as jest.MockedFunction<typeof getAllUsersInMatchmakingQueue>;
    const mockedCreateLobbyAndInsertPlayersIntoLobby = createLobbyAndInsertPlayersIntoLobby as jest.MockedFunction<typeof createLobbyAndInsertPlayersIntoLobby>;
  ...
  it("should call the matchmaking function if there are at least 5 players in the matchmaking queue.", async () => {
    const mockedGetAllUsersInMatchmakingQueue = getAllUsersInMatchmakingQueue as jest.MockedFunction<typeof getAllUsersInMatchmakingQueue>;
    const mockMatchmaking = matchmaking as jest.MockedFunction<typeof matchmaking>;
    mockedGetAllUsersInMatchmakingQueue.mockResolvedValueOnce(mockGetAllUsers as MatchMakingEntryRowPacket[]);
    mockMatchmaking.mockReturnValueOnce(mockMatchmakingData)
    await matchmakingJob();
    expect(mockedGetAllUsersInMatchmakingQueue).toHaveBeenCalled();
    expect(mockMatchmaking).toHaveBeenCalled();
  });
  it("should not call the createLobbyAndInsertPlayersIntoLobby function if matchmaking returns NULL", async () => {
    const mockedGetAllUsersInMatchmakingQueue = getAllUsersInMatchmakingQueue as jest.MockedFunction<typeof getAllUsersInMatchmakingQueue>;
    const mockMatchmaking = matchmaking as jest.MockedFunction<typeof matchmaking>;
    const mockedCreateLobbyAndInsertPlayersIntoLobby = createLobbyAndInsertPlayersIntoLobby as jest.MockedFunction<typeof createLobbyAndInsertPlayersIntoLobby>;
    mockedGetAllUsersInMatchmakingQueue.mockResolvedValueOnce(mockGetAllUsers as MatchMakingEntryRowPacket[]);
  ...
  it("should call the createLobbyAndInsertPlayersIntoLobby function if matchmaking returns a value", async () => {
    const mockedGetAllUsersInMatchmakingQueue = getAllUsersInMatchmakingQueue as jest.MockedFunction<typeof getAllUsersInMatchmakingQueue>;
    const mockMatchmaking = matchmaking as jest.MockedFunction<typeof matchmaking>;
    const mockedCreateLobbyAndInsertPlayersIntoLobby = createLobbyAndInsertPlayersIntoLobby as jest.MockedFunction<typeof createLobbyAndInsertPlayersIntoLobby>;
    mockedGetAllUsersInMatchmakingQueue.mockResolvedValueOnce(mockGetAllUsers as MatchMakingEntryRowPacket[]);
